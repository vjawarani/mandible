...
class MandibleTaskBarIcon(wx.adv.TaskBarIcon):
    ...
    def __init__(self, frame):
        ...
        self.frame = frame
        MandibleIcon = wx.Image("mandible120.png", wx.BITMAP_TYPE_PNG, -1)
        # Set the image
        icon = self.MakeIcon(MandibleIcon)
        self.SetIcon(icon, "Clear Files")
        self.imgidx = 1
    ...
    def CreatePopupMenu(self):
        ...
        """
        menu = wx.Menu()
        menu.Append(self.TBMENU_RESTORE, "Open Full Window")
        menu.Append(self.TBMENU_CLOSE, "Quit Mandible")
        return menu
...
class MainFrame(wx.Frame):
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, title="Mandible")
        self.tbicon = MandibleTaskBarIcon(self)
